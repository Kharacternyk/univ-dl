...
відповідно.
У файлі [`dataset.py`](./dataset.py) реалізовано клас для підвантаження, токенізації,
та нормалізації довжини речень.
...
оскільки за такого обсягу даних кількість ітерацій тренування не досягала навіть однієї епохи.
...
### Результати зі штрафом за перевикористання токенів
